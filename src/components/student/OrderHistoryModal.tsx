      ...
      <div className="bg-white rounded-3xl max-w-xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
            ...
            <>
              {userOrders.length === 0 ? (
                ...
                userOrders.map((ord) => (
                  <div
                    key={ord.id}
                    className="border border-slate-200 rounded-2xl p-4 bg-white hover:border-slate-300 transition"
                  >
                    ...
                    <div className="pt-2 border-t border-slate-100 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 text-xs font-bold rounded-lg bg-slate-100 text-slate-800 hover:bg-slate-200 transition"
                        >
                          View Token
                        </button>
            ...
            <div className="space-y-3">
              {favoriteItems.length === 0 ? (
                ...
                favoriteItems.map((item) => (
                  <div
                    key={item.id}
                    className="border border-slate-200 rounded-2xl p-3 flex items-center justify-between gap-3 bg-white"
                  >
        ...
        {feedbackOrder && (
          <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-xs flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-3xl max-w-sm w-full p-5 shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
              <div className="flex items-center justify-between pb-2 border-b border-slate-100">
              ...
              <div className="mt-4 space-y-3 text-xs">
                  ...
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4, 5].map((st) => (
                      ...
                      >
                        <Star
                          className={`w-6 h-6 ${
                            foodQuality >= st ? 'fill-amber-500' : 'text-slate-200'
                          }`}
                        />
                      </button>
                    ))}
                  ...
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4, 5].map((st) => (
                      ...
                      >
                        <Star
                          className={`w-6 h-6 ${
                            prepSpeed >= st ? 'fill-amber-500' : 'text-slate-200'
                          }`}
                        />
                      </button>
                    ))}
                  ...
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4, 5].map((st) => (
                      ...
                      >
                        <Star
                          className={`w-6 h-6 ${
                            serviceRating >= st ? 'fill-amber-500' : 'text-slate-200'
                          }`}
                        />
                      </button>
                    ))}
                ...
                {/* Quick Tags */}
                <div>
                  <div className="font-bold text-slate-700 mb-1">Feedback Tag</div>
                ...
                <div>
                  <textarea
                    ...
                    className="w-full p-2 border border-slate-200 rounded-xl text-xs focus:ring-1 focus:ring-amber-500"
                  />
                </div>
              </div>
              ...
              <div className="mt-4 flex gap-2">
                <button
                  onClick={() => setFeedbackOrder(null)}
                  className="flex-1 py-2 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 hover:bg-slate-50"
                >
                  Cancel
                </button>
                <button
